...
public class GlobalPosition implements Runnable {
     ...
     */
    public GlobalPosition(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
    ...
    /**
     * Updates the global (x, y, theta) coordinate position of the robot using the
     * odometry encoders
     */
    private void globalCoordinatePositionUpdate() {
        ...
        double horizontalChange = rawHorizontalChange
                - (changeInRobotOrientation * horizontalEncoderTickPerDegreeOffset);
